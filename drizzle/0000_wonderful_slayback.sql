...
CREATE TABLE "profiles" (
	...
	"attends_hotels" boolean DEFAULT true,
	"attends_homes" boolean DEFAULT true,
...
CREATE INDEX "profiles_body_type_idx" ON "profiles" USING btree ("body_type");--> statement-breakpoint
